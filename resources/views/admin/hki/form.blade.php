        ...
        <div class="card-body">
            <form method="POST"
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full">
                        <label for="url">Link Sertifikat / Dokumen <span class="form-label-optional">(opsional)</span></label>
                        <input type="url" id="url" name="url" class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}"
                               value="{{ old('url', $hki->url) }}" placeholder="https://...">
                        <span class="form-hint">Link ke sertifikat HKI atau halaman pendaftaran.</span>
